...
CONFIG = AppConfig(
    data=DataConfig(
        product="300etf",
        etf_dir="data/300etf/etf",
        opt_dir="data/300etf/option",
        hedge_etf_dir="data/300etf/etf",
    ),
    ...
    strategy=StrategyConfig(
        ...
        long_open_iv_threshold=0.080,
        long_close_iv_threshold=0.240,
        min_exit_dte=3,
        short_signal_mode="absolute",
        short_open_iv_threshold=0.155,
        short_close_iv_threshold=0.130,
        short_open_pullback_iv_threshold=0.29,
        short_open_iv_percentile_threshold=0.75,
        short_close_iv_percentile_threshold=0.60,
        short_stop_loss_enabled=True,
        short_stop_loss_rate=0.15,
